...
Transforms allow building complete Touchbook content within a directive by
assembling content from parts.
At this point, exclusively to support `tb-code` directives.

The transforms feature stores named code blocks or `tb-file` in the DOM
environment for assembling into a `tb-code` block.
